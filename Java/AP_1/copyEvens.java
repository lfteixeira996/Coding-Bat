...
public class copyEvens {
	...
	public void Test1()
	{
		...
		int[] input = {3, 2, 4, 5, 8};
		int[] expected = {2, 4};		
		assertEquals("copyEvens([3, 2, 4, 5, 8], 2) → [2, 4]", expected, copyEvens(input, 2));
		i++;
	}
	...
	public void Test2()
	{
		...
		int[] input = {3, 2, 4, 5, 8};
		int[] expected = {2, 4, 8};		
		assertEquals("copyEvens([3, 2, 4, 5, 8], 3) → [2, 4, 8]", expected, copyEvens(input, 3));
		i++;
	}
	...
	public void Test3()
	{
		...
		int[] expected = {6, 2, 4};		
		assertEquals("copyEvens([6, 1, 2, 4, 5, 8], 3) → [6, 2, 4]", expected, copyEvens(input, 3));
		i++;
	}
